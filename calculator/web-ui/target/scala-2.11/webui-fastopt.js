...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var op = new $c_Lcalculator_Calculator$$anonfun$computeValues$1().init___sci_Map(namedExpressions);
  return $as_sci_Map($s_sc_TraversableOnce$class__foldLeft__sc_TraversableOnce__O__F2__O(namedExpressions, z, op))
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__sci_Set__D = (function(expr, references, visited) {
  _eval: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      if (visited.contains__O__Z(name)) {
        return (NaN)
      } else {
        var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
        var temp$visited = $as_sci_Set(visited.$$plus__O__sc_Set(name));
        expr = temp$expr;
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a, references, visited) + this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b, references, visited))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a$2, references, visited) - this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b$2, references, visited))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a$3, references, visited) * this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b$3, references, visited))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      var bEval = this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(b$4, references, visited);
      return (((bEval !== bEval) || (bEval === 0)) ? (NaN) : (this.eval__Lcalculator_Expr__sci_Map__sci_Set__D(a$4, references, visited) / bEval))
    } else {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__sci_Map__T2__sci_Map = (function(evalMap, namedExpr) {
  var jsx$5 = namedExpr.$$und1$f;
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, namedExpr$1) {
    return (function() {
      var jsx$4 = $m_Lcalculator_Calculator$();
      var jsx$3 = $as_Lcalculator_Expr($as_Lcalculator_Signal(namedExpr$1.$$und2$f).apply__O());
      var jsx$2 = arg$outer.namedExpressions$1$f;
      var array = [$as_T(namedExpr$1.$$und1$f)];
      if (($uI(array["length"]) === 0)) {
        var jsx$1 = $m_sci_Set$EmptySet$()
      } else {
        ...
        var jsx$1 = $as_sc_GenTraversable(b.elems$1)
      };
      return jsx$4.eval__Lcalculator_Expr__sci_Map__sci_Set__D(jsx$3, jsx$2, $as_sci_Set(jsx$1))
    })
  })(this, namedExpr));
  return evalMap.updated__O__O__sci_Map(jsx$5, new $c_Lcalculator_Signal().init___F0(expr))
});
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__O__O__O = (function(v1, v2) {
  return this.apply__sci_Map__T2__sci_Map($as_sci_Map(v1), $as_T2(v2))
});
